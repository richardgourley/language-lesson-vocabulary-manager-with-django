...
def search_entries(request):
    if request.POST and request.POST['entry_search'] == '':
        return render(request, 'lessons/searchentries.html', {
            'search_result':None,
            'message':'Please enter a word or sentence'
        })
    if request.POST:
        ...
        return render(request, 'lessons/searchentries.html', {'search_result':search_result, 'message':message})
    
    return render(request, 'lessons/searchentries.html', {'search_result':'','message':''})
